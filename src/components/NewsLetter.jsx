        ...
        <div className='flex flex-col md:flex-row  items-center justify-between gap-30 lg:gap-24'>
            ...
            <div className='md:w-1/3 w-full'>
                ...
                <div className='space-y-3'>
                    ...
                    <button className='mt-8 bg-indigo-600 text-white px-9 py-3 cursor-pointer rounded-full hover:bg-indigo-700 transition-all'>Get Started</button>
                </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    {services.map((service,index)=>(
                        <div key={index} className='bg-white max-w-72 cursor-pointer rounded-2xl p-6 hover:scale-105 hover:shadow-xl transition-all duration-300 '>
                            ...
                            <h3 className='text-cl font-semibold mb-2'>{service.title}</h3>
